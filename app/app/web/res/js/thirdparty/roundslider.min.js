...
(function(factory) {
  ...
  RoundSlider.prototype = {
    ...
    _setRadius: function() {
      ...
      if (circleShape.indexOf("half") === 0) {
        switch (circleShape) {
          ...
          case "half-bottom":
            height = r;
            actualHeight = r + extraSize;
            break;
          case "half-left":
          case "half-right":
            width = r;
            actualWidth = r + extraSize;
            break;
        }
      ...
      if (extraSize !== 0) this.innerContainer.css({
        "height": actualHeight,
        "width": actualWidth
      });
    ...
    _handleDefaults: function() {
      ...
      return {
        angle: this._valueToAngle(defaultValue),
        value: defaultValue
      };
    },
    ...
    _updateARIA: function(value) {
      ...
      if (this._rangeSlider) {
        ...
        if (this._active == 1) handles.eq(1).attr({
          "aria-valuemin": value
        });
    ...
    _tooltipValue: function(value, index) {
      var returnValue = this._raise("tooltipFormat", {
        value: value,
