...
func (y *Yeelight) On(effect string, duration string) string {
	return y.SetPower("on", effect, duration)
}

// Off method is used to switch off the smart LED
func (y *Yeelight) Off(effect string, duration string) string {
	return y.SetPower("off", effect, duration)
}
